...
# Descripciones predeterminadas limpias para acciones nativas
BUILTIN_DESCRIPTIONS = {
    ...
    "screenshot": "Captura de pantalla interactiva",
...
def parse_niri_config():
    ...
    for raw_line in binds_block.splitlines():
        ...
        # Simplificar visualización de workspaces 1 al 10
        ...
        # Limpiar cualquier residuo de texto
        desc = desc.strip()
...
def main():
    ...
    max_key_len = max(len(e["key"]) for e in entries) + 3
